...
$.ajax({
  ...
  data: {
    key: 'DNPBZ-7246Q-ABT5V-4UW55-WZZF7-XYFAH',
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(121.652161, 31.259972, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
